...
/**
 * Same markup/CSS classes as `@/components/PhoneFrame`, minus its hardcoded
 * `#phone-screen` / `#phone-screen-viewport` ids — this one is mounted several times at
 * once (one per "how it works" step) on the landing page, so it can't reuse those ids
 * without duplicating them across the page.
 */
export function MockPhoneFrame({ children }: { children: ReactNode }) {
  return (
