/**
 * Hand-rolled inline SVG icons for the landing page (no icon library dependency).
 * Ported from `designs/navar_design/src/components/landing/LandingIcons.tsx`. `className`
 * defaults (`w-5 h-5` etc.) are plain CSS utility classes defined alongside the landing CSS
 * in `globals.css` — apps/web has no Tailwind.
 */
